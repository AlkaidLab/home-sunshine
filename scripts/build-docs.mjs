...
<html lang="zh-CN">
  <head>
    ...
    <title>${escapeHtml(title)} - 瑶光流梦</title>
    <style>
      :root { color-scheme: light; --ink: #213547; --muted: #667985; --line: #d8e2e8; --accent: #1769aa; --panel: #f4f8fa; --strong: #183b56; }
      * { box-sizing: border-box; }
      body { margin: 0; background: #eef3f6; color: var(--ink); font-family: "Microsoft YaHei", "Noto Sans CJK SC", "Segoe UI", sans-serif; line-height: 1.8; }
...
for (const file of files) {
  ...
  await writeFile(join(outputDir, outputName), pageTemplate(title, markdownToHtml(source)), 'utf8')
...
await writeFile(join(outputDir, 'index.html'), pageTemplate('文档中心', indexBody), 'utf8')
